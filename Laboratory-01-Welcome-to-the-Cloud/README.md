...
-Creating a Home Directory Using Linux on Killercoda Playground and using Terminal and Command codes prompt, How to Markdown, create folder, Edit a file, Check some computer components, username, check Disk and Memory available.
-Create a Public Repositories on github, crate new file, add new folder, commit changes and so on.
...
-on github i learned to create a repository and add basic files and folder i creating or adding new projects by committing changes.
